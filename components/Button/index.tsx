...
export const BUTTON_STYLES_SECONDARY = 'px-4 py-2 text-sm rounded-lg border border-gray-400 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800';
